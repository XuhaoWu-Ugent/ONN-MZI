...
file_path = r'C:\Users\17958\AppData\Roaming\JetBrains\PyCharm2025.2\scratches\mzi_correction\in5\MZI_array_output.txt'
...
mzi_numbers = [2, 7, 12, 17, 22, 31, 35, 39, 43, 47]

# Filter for output port o5
data_o1 = data[data['output_port'] == 5]
...
# Save the plot
plt.savefig(r'C:\Users\17958\AppData\Roaming\JetBrains\PyCharm2025.2\scratches\mzi_correction\in5\mzi_power_analysis_fitted.png', dpi=300, bbox_inches='tight')
