...
# ==========================================
# Alpha sweep with Clean Optical FC.
# Clean FC (P1+P3 cleanup) hit 86.95% at alpha=beta=0 — this sweep
# tests whether adding logit distillation can push beyond that now
# that the architectural bottlenecks are removed. beta=0 throughout.
# ==========================================
K_VALUE=15
HIDDEN_CHANNELS=4
FIXED_SIGMA=0.15
KD_ALPHA_LIST="0.0 0.01 0.05 0.1 0.2 0.3 0.5 0.75 1.0"
KD_BETA=0.0
EPOCHS=30
...
echo "=========================================="
echo "Clean FC Alpha Sweep (beta=$KD_BETA, K=$K_VALUE, ch=$HIDDEN_CHANNELS)"
...
for KD_ALPHA in $KD_ALPHA_LIST; do
    echo ""
    echo ">>> Starting Clean-FC Distillation alpha=$KD_ALPHA (beta=$KD_BETA)"
...
echo ""
echo "Clean-FC alpha sweep completed."
