...
def get_args():
    ...
    parser.add_argument('--input-channels', type=int, default=3,
                        help='Number of input channels (default: 3) for CIFAR-10')
    parser.add_argument('--hidden-channels', type=int, nargs='+', default=[12, 24],
                        help='List of hidden channels for each layer (default: [12, 24])')
